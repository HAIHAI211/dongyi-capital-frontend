        ...
        vueI18n: {
          ...
          messages: {
            cn: {
              ...
              l_3_p_3: `来自汽车行业的工程师；材料领域科学家；化工领域工程师；运筹学、应用数学专家。`,
              last_title: `过往案例`,
            ...
            en: {
              ...
              l_3_p_3: `and former engineers from automobile industry. Members also include scientists in the materials field, engineers in the chemical industry, and experts in operations research & applied mathematics.`,
